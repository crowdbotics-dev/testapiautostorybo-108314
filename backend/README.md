...
## Project Structure
    ...
    ├── testapiautostorybo_108314  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_108314`
...
2. Clone this repo and `cd testapiautostorybo_108314`
